...
#define CHARYBDIS_DRAGSCROLL_BUFFER_SIZE user_config3.EE_DragScroll
#define CHARYBDIS_DRAGCURSER_DPI 200
#define CHARYBDIS_DRAGCURSER_REVERSE_Y
#define CHARYBDIS_DRAGCURSER_BUFFER_SIZE user_config3.EE_DragCurser
